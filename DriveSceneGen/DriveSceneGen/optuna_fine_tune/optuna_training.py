...
def objective(trial):
    ...
    INFER_STEPS = trial.suggest_int("INFER_STEPS", 300, 2000)  
    
    # 调用 training_mine 函数
    training_mine(NUM_EPOCHS=NUM_EPOCHS, INFER_STEPS=INFER_STEPS)  # 调用训练函数
...
if __name__ == "__main__":
    study = optuna.create_study(
        ...
        study_name="training-optimization"  # 研究名称
    )
