...
from waymo_open_dataset.protos import dataset_pb2 as open_dataset
...
if __name__ == "__main__":
    ...
    # /data/haibin/waymo/try
    parser.add_argument('--load_path',default="/data/haibin/ML_DM/training_20s", type=str, help='path to dataset files') # load
    # parser.add_argument('--load_path',default="/home/haibin/ML_Models/DriveSceneGen/data/raw", type=str, help='path to dataset files') # load
    parser.add_argument('--save_path', default="/data/haibin/ML_DM/preprocess_training_20s",type=str, help='path to save processed data')
