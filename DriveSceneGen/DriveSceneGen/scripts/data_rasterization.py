...
if __name__ == "__main__":
    ...
    # parser.add_argument('--load_path',default="/data/haibin/ML_DM/preprocess_v2", type=str, help='path to dataset files')
    parser.add_argument('--load_path',default="/data/haibin/ML_DM/preprocess_training_20s", type=str, help='path to dataset files')
    parser.add_argument('--save_path', default="/data/haibin/ML_DM/rasterized_training_20s/",type=str, help='path to save processed data')
    ...
    tensor_output_dir= os.path.join(output_dir, f"GT_A100_s{map_range}_dxdy_agents_img")
